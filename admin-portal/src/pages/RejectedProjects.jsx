      ...
      <div className="responsive-container py-4 sm:py-6 lg:py-8">
        <div className="mb-4 sm:mb-6 lg:mb-8">
          <SplitText
            ...
            tag="h1"
            className="[font-family:'Inter',Helvetica] font-bold text-[#FF5247] text-6xl sm:text-6xl md:text-8xl lg:text-8xl xl:text-8xl 2xl:text-8xl tracking-[-0.5px] leading-tight"
            delay={50}
            duration={0.6}
            ease="power3.out"
            splitType="lines"
          ...
          <div className="flex flex-col items-center sm:items-end gap-2 w-full sm:w-auto">
            ...
            >
              ...
              <select
                ...
                className="w-full sm:w-auto px-1 py-0.5 text-xs border border-[#FF5247] rounded-full bg-white text-[#FF5247] focus:outline-none shadow-sm hover:border-[#e6453a] transition-colors duration-200 touch-button"
              >
          ...
          <div className="grid gap-2 sm:gap-2 lg:gap-2 cards-enter">
            {projects.length === 0 && (
              <div className="text-center py-8 sm:py-12">
                <div className="text-gray-400 text-base sm:text-lg">No rejected projects found.</div>
              </div>
            )}
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-5 sm:gap-5 flex-shrink-0">
                      <div className="flex flex-col items-center gap-1">
                        <CountUp end={0} duration={2} suffix="%" className="text-sm sm:text-base font-bold text-gray-700" />
                        <div className="w-8 h-1 bg-gray-300 rounded-full">
                          <div className="w-0 h-full bg-[#FF5247] rounded-full"></div>
                        </div>
                      </div>
      ...
      {hoverPreview.show && (
        ...
        >
          <img
            ...
            alt="hover-preview"
            className="w-32 h-32 sm:w-48 sm:h-48 object-cover rounded-2xl shadow-2xl border-2 border-red-500 transform transition-all duration-300 ease-out hover:scale-105"
          />
        </div>
      )}
      ...
      {previewImg && (
        ...
        >
          <img
            src={previewImg}
            alt="preview"
            className="max-h-full max-w-full rounded shadow-lg border border-red-500"
          />
        </div>
      )}
    </div>
